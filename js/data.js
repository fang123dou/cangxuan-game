...
const CARD_POOL = [
  ...
  [
    ...
    { id:"pofang", name:"破防了",      eff:"话术暴击：说中心结，对方战力 -8%；结仇速度 +20%（心魔劫判定 +10）", mod:{socialP:8, dmgP:3}, special:"pofang" },
  ...
  /* ---- 圣品（金） ---- */
  [
    { id:"qiyunzi",name:"气运之子",    eff:"气运 +2；走路捡钱（每日 10%，铜钱 +3~15）；高运压低敌方暴击——强敌也会降智", mod:{luckFlat:2}, special:"lucky" },
