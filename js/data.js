...
const PETS = [
  { id:"xuediao", name:"雪貂·雪团", tier:1, region:null, realm:2,
    attr:{ agi:2.0 }, card:"踏雪无痕|2|雪貂之灵附体：身法如雪上无痕|agiP:5,escapeP:5",
  ...
  { id:"huiyi", name:"荒狼·灰耳", tier:1, region:"beiyuan", realm:3,
    attr:{ str:2.0 }, card:"狼顾|2|荒狼之魂：出手有狼性，孤注一掷|dmgP:5,strP:2",
  ...
  { id:"chiling", name:"赤翎雀·小火", tier:2, region:null, realm:7,
    attr:{ int:2.5 }, card:"雀鸣示警|2|赤翎雀之灵：六识先觉，险至先知|escapeP:8,intP:2",
  ...
  { id:"yanbei", name:"岩背龟·稳稳", tier:2, region:"nanling", realm:7,
    attr:{ con:2.5 }, card:"龟息|2|岩背龟之灵：气血绵长，不动如山|conP:3,defP:5",
  ...
  { id:"yingbao", name:"影豹·逐影", tier:3, region:"nanling", realm:13,
    attr:{ agi:5.0 }, card:"影随形|3|影豹之灵：动如鬼魅，来去无形|agiP:10,escapeP:8",
  ...
  { id:"bitong", name:"碧瞳狐·阿碧", tier:3, region:"zhongzhou", realm:13,
    attr:{ int:4.0 }, card:"狐鉴|3|碧瞳狐之灵：慧眼识人，人缘自来|intP:6,socialP:10",
  ...
  { id:"qingjiao", name:"青蛟·小青", tier:3, region:"sihai", realm:13,
    attr:{ con:4.0, str:2.0 }, card:"蛟息|3|青蛟之灵：气血如潮，生生不息|allP:5,hpRegenP:10",
  ...
  { id:"baize", name:"白泽残裔·小泽", tier:4, region:null, realm:17, luck:6,
    attr:{ int:6.0, luck:0 }, card:"白泽之瞳|4|白泽残裔之灵：通万物之情，晓鬼神之事——气运 +1|luckFlat:1,intP:5",
