...
const REGIONS = {
  ...
  ximo: { key:"ximo", name:"西漠", match: p => /西漠|沙海/.test(p),
    surviveName: "凡品任务：找到水",
    surviveDesc: "西漠的沙海吃人不吐骨头：水比金贵，粮比水贱不了多少。先活下来——水囊、荫凉、不碰沙盗的刀，都是命。",
    weatherW: ["干冷", "风沙", "晴寒", "沙暴", "霜晨"], weatherS: ["酷热", "热风", "风沙", "晴", "沙暴"],
    badWx: ["风沙", "沙暴"],
    foodMult: 1.8, foodNote: "西漠缺水少粮，食物比云州贵八成",
    aiHint: "本地为西漠（黄沙万里，设定集第五章）：佛国与沙盗并存，地下埋着上古战场——水是命根（商铺食物价 ×1.8，可写水比粮贵的剧情）；绿洲市集物价随行就市，僧人化缘与沙盗收『买路钱』都是常态；上古战场遗迹、佛国石窟、沙盗马队是本地特色剧情素材。",
    openings: [
