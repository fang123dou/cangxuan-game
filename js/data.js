...
const IDENTITIES = [
  ...
  { grade:"吉", name:"海商账徒",     desc:"算盘与缆绳之间讨生活，风浪比掌柜的脸色善变。", mods:{int:1,luck:0}, money:600, note:"「算盘与缆绳」工钱利钱 +5%", place:"四海 · 潮间 · 珠蚌埠 · 埠头商栈" },
  { grade:"平", name:"渔家子",       desc:"海税、风暴、渔霸，一样比浪凶。", mods:{con:1}, money:50, note:"「浪里白条」水性：敏捷 +2%、逃脱 +5%", place:"四海 · 潮间 · 珠蚌埠 · 渔棚" },
...
const NOTE_FX = {
  ...
  "沙海弃儿": { heatRes: 10 },
  "瘴林逃难人": { poiRes: 10 },
  "落海病徒": { agiP: 2, escapeP: 5 },
  "逃出的鲛奴": { agiP: 2, escapeP: 5 },
};
    ...
    openings: [
      { id: "rb_shubao", place: "北地 · 渊口戍堡 · 烽堡暗哨", title: "极 夜 烽 堡",
        lines: [
          ...
          (n) => `老戍卒往火堆里添了根柴，火光映着他脸上的冻疮：「${n}，撑过今夜，明早堡里分粥。北原的规矩——活着的人，才有明天。」`,
      ...
      { id: "rb_bingdao", place: "北地 · 冰原商道", title: "雪 原 弃 货",
        lines: [
          ...
          (n) => `远处狼嚎一声近过一声。你攥紧那把豁口小刀——${n}，在北原，狼和你一样饿，先怂的那个先死。`,
    ...
    openings: [
      { id: "rb_yaopu", place: "中州 · 药王谷 · 外门药圃", title: "药 圃 寒 夜",
        lines: [
          ...
          (n) => `老药童把碗底最后一口药汤也倒给你：「${n}，药膳饼我藏在柴堆第三层。明日点卯，你得自己站着走出去——我扶不动你。」`,
        ], quest: "退烧，别被点卯除名",
      ...
      { id: "rb_dacheng", place: "中州 · 皇朝大城 · 城南脚店", title: "帝 畿 雪 巷",
        lines: [
          ...
          (n) => `老板娘拨完算盘，忽然丢给你一件旧蓑衣：「${n}，雪巷今夜要冻死人，明儿铺子还得开门。蓑衣不白给——明早帮我卸两车菜。」`,
        ], quest: "在三笔账到期前挣到活路",
    ...
    openings: [
      { id: "rb_shahai", place: "西漠 · 沙海 · 废弃驼队营地", title: "沙 海 残 营",
        lines: [
          ...
          (n) => `你把最后一口浑水含在嘴里，没舍得咽。半埋的经幢上，佛面的微笑被风沙磨去了半边——${n}，佛在西边三十里，命在自己腿上。`,
    ...
    openings: [
      { id: "rb_zhanglin", place: "南岭 · 十万大山 · 瘴林边缘", title: "瘴 林 雪 夜",
        lines: [
          ...
          (n) => `棚外的脚步声停了。火光里，一双幽绿的眼睛在棚缝外一闪而过——它也在等火熄。${n}，把柴架空些，让火烧到天亮。`,
        ], quest: "守住火，别进任何一张嘴",
        iden: { grade: "狱", name: "瘴林逃难人", desc: "寨子烧了以后扎进十万大山的逃难者，高烧三日，半把驱瘴草是全部家当。", note: "「瘴林逃难人」瘴毒抗性 +10%", place: "南岭 · 十万大山 · 瘴林边缘" } },
    ] },
  sihai: { key:"sihai", name:"四海", match: p => /四海|东海|南海|西海|珠蚌埠|听潮坞|潮间/.test(p),
    surviveName: "凡品任务：别沉在这片海里",
    surviveDesc: "四海的冬天是风浪与寒水。先活下来——干爽的衣裳、热鱼汤、一条不漏水的船，都是命。",
    weatherW: ["风浪","海雾","阴雨","寒潮","阴晦"], weatherS: ["晴","海风","平潮","微风","细雨"],
    badWx: ["风浪","海雾","寒潮"],
    foodMult: 1.4, foodNote: "四海路遥粮贵，食物比云州贵四成",
    aiHint: "本地为四海（设定集第五章）：东海龙宫、南海鲛国、西海雾海、北海归墟——归墟是仙路断绝之处，只可作遥远的禁忌方向，严禁写成可随意抵达之地；潮间埠头是龙宫水卒、鲛国织户、海商水手杂居之地；海税、渔霸、风暴潮是本地常客；机缘在海底，消息在码头。",
    sect: { name: "听潮坞", npc: "听潮坞水手阿汐" },
    openings: [
      { id: "rb_hainan", place: "四海 · 潮间 · 沉船残骸", title: "浪 间 沉 船",
        lines: [
          "你在断成两截的船楼里醒来——高烧三天，浑身滚烫，怀里揣着半块盐渍的硬饼。昨夜风暴撕了商船，会水的逃了，不会水的沉了，你这个烧得不省人事的，被浪拍在残骸上，居然还活着。",
          (n) => `舱外的海一声接一声地砸着断板。远处云里透出一线帆影——最近的埠头，顺风也要划半日。${n}，饼吃掉，然后找一块还浮得起来的板。`,
          (n) => `三里外的珠蚌埠传来墟市的喧闹，隔着海风断断续续。${n}，那声音里有人间烟火——往有烟的地方游。`,
        ], quest: "在寒水里找到活路",
        iden: { grade: "狱", name: "落海病徒", desc: "海难后被浪拍在沉船残骸上的病客，高烧三日，半块盐饼是全部家当。", note: "「浪里白条」水性：敏捷 +2%、逃脱 +5%", place: "四海 · 潮间 · 沉船残骸" } },
      { id: "rb_jiaonu", place: "四海 · 潮间 · 珠蚌埠外礁", title: "礁 上 鲛 奴",
        lines: [
          "你在珠蚌埠外的黑礁上醒来——高烧三天，浑身滚烫，腕上留着一圈银环勒出的青紫。你是押奴船上的鲛奴，昨夜风暴撕了船，你会水，竟从沉船的锁链里游了出来。",
          (n) => `礁下的潮水一声声催命。顺风三里，埠头的炊烟隐约可见——腕上的银环不敲碎，到了岸上也是人家的货。${n}，砸开它，然后游。`,
          (n) => `潮水在涨，黑礁一寸寸矮下去。你把银环垫在礁石上，抡起石块——第一下，麻；第二下，裂；第三下，${n}，你自由了。`,
        ], quest: "砸开银环，游到有人烟的埠头",
        iden: { grade: "狱", name: "逃出的鲛奴", desc: "押奴船上脱身的病奴，高烧三日，腕留银环勒痕，离埠头三里海路。", note: "「浪里白条」水性：敏捷 +2%、逃脱 +5%", place: "四海 · 潮间 · 珠蚌埠外礁" } },
    ] },
};
...
const SHOP_BASE = [
  ...
  { id: "jiangniu", name: "酱牛肉", price: 15, desc: "卤透的酱牛肉，撕着吃，顶饱。", kind: "食物", use: "eat", food: 60 },
  { id: "babao", name: "八宝干粮", price: 28, desc: "行商压箱的八宝干粮，耐放顶饿。", kind: "食物", use: "eat", food: 78 },
  { id: "linggu", name: "灵谷饭", price: 60, desc: "灵谷蒸的饭，粒粒生香，凡人吃了百病不侵。", kind: "食物", use: "eat", food: 92 },
  { id: "baiwei", name: "百味羹", price: 99, desc: "百味斋的招牌羹，凡俗顶级的吃食。", kind: "食物", use: "eat", food: 110 },
...
/* ============ 地区特产（行商系统）：产地贱买，异地贵卖，行情随地域需求浮动 ============ */
const TRADE_GOODS = [
  { id:"yunjinDuan", name:"云锦缎", region:"yunzhou", price:60, sell:45, kind:"特产", desc:"云州织户的手艺，流光暗纹。北原贵胄与四海船商都好这一口。" },
  { id:"qingshiYan", name:"青石砚", region:"yunzhou", price:40, sell:30, kind:"特产", desc:"青石城的老坑砚，发墨如油。中州文士高价收。" },
  { id:"sangluoJiu", name:"桑落酒", region:"yunzhou", price:15, sell:10, kind:"特产", desc:"云州米酒，桑落时开缸。西漠与四海缺粮水之地一杯难求。" },
  { id:"xuelangPiu", name:"雪狼皮裘", region:"beiyuan", price:220, sell:150, kind:"特产", desc:"北原雪狼整块皮裘，轻暖无双。中州达官显贵冬日必备。" },
  { id:"dongyuSui", name:"冻玉髓", region:"beiyuan", price:90, sell:60, kind:"特产", desc:"北原冰河底挖出的暖玉，贴身不凉。南岭炼器师收去镇炉。" },
  { id:"laosu", name:"酪酥", region:"beiyuan", price:12, sell:8, kind:"特产", desc:"北原牧民的奶食，高热耐放。跑商路上的硬干粮。" },
  { id:"guanyinCi", name:"官窑白瓷", region:"zhongzhou", price:130, sell:90, kind:"特产", desc:"帝畿官窑的细白瓷，薄如蛋壳。四海番商整船收购。" },
  { id:"dijiMing", name:"帝畿香茗", region:"zhongzhou", price:45, sell:30, kind:"特产", desc:"中州贡茶园出的雨前茶。南岭山寨以蛊银换茶，价翻三倍。" },
  { id:"jingtiePei", name:"精铁兵胚", region:"zhongzhou", price:160, sell:110, kind:"特产", desc:"军坊流出的精铁条，炼器的好底子。南岭西漠兵器行常年收。" },
  { id:"putaoJiu", name:"葡萄酒", region:"ximo", price:25, sell:15, kind:"特产", desc:"西漠绿洲的葡萄酒，窖藏十年。北原寒夜一杯值千金。" },
  { id:"huohuanBu", name:"火浣布", region:"ximo", price:110, sell:75, kind:"特产", desc:"西漠火山的奇异织物，入火不焚。炼器师与权贵抢着要。" },
  { id:"shajinLi", name:"沙金粒", region:"ximo", price:140, sell:95, kind:"特产", desc:"西漠河滩淘的沙金。中州钱庄常年挂牌收购。" },
  { id:"zhangyunCha", name:"瘴云茶", region:"nanling", price:35, sell:22, kind:"特产", desc:"南岭瘴雾里长出的野茶，以毒养香。中州药铺收去配解毒丹。" },
  { id:"guyinShi", name:"蛊银饰", region:"nanling", price:85, sell:55, kind:"特产", desc:"南岭苗寨的银饰，纹样里封着微蛊。中州贵妇当异域奇珍买。" },
  { id:"baixiangCao", name:"百香草", region:"nanling", price:20, sell:13, kind:"特产", desc:"南岭百种香草扎成的香束，熏衣防瘴。北原 caravan 过冬必备。" },
  { id:"haiZhu", name:"海珠", region:"sihai", price:120, sell:80, kind:"特产", desc:"四海珠民潜采的深海明珠。云州中州首饰行高价收。" },
  { id:"longxianXiang", name:"龙涎香", region:"sihai", price:200, sell:140, kind:"特产", desc:"海中异兽所吐，焚之满室生风。中州显贵与修士炼丹皆求之。" },
  { id:"jiaoxiao", name:"鲛绡", region:"sihai", price:70, sell:48, kind:"特产", desc:"鲛人所织的轻绡，入水不濡。北原贵女冬宴争着裁衣。" },
];
...
const XIANQI = [
  { id:"liangtianchi", name:"鸿蒙量天尺", region:null, realm:19, flag:"sysQuestioned", flagText:"问天：向「系统」问出那句话",
    ...
    trial:{ check:"int*8+luck*3+d30>75", hint:"器灵之试：看清尺上刻度的走向（智力/气运判定，败则神魂受创）。",
      successText:"尺影在你识海里铺成一条长河——三万年的刻度你一一看过，没有疯。尺，认了。",
      failText:"刻度倒灌入识海，你闷哼一声栽倒——看懂的不足万一，神魂如被丈量过般钝痛。" },
  ...
  { id:"guiXuAnchor", name:"归墟锚", region:"beiyuan", realm:19, flag:"devourWhisper", flagText:"听完渊口裂缝里的「低语」",
    ...
    trial:{ check:"con*8+str*4+luck*2+d30>80", hint:"器灵之试：锚身重逾山岳，须以血肉之躯撼动分毫（体质/力量判定，败则重创）。",
      successText:"你骨节咯咯作响，锚身被你从冰里拔起一线——就这一线，三万年没人做到。锚，认了。",
      failText:"锚身纹丝未动，你的筋骨先扛不住了——气血翻涌，一口血喷在冰面上，转眼冻成红冰。" },
  ...
  { id:"wangchuanZhan", name:"忘川盏", region:null, realm:17, flag:"pioneer_fen", flagText:"祭过荒野里那座无名坟",
    ...
    trial:{ check:"int*7+luck*4+d30>70", hint:"器灵之试：盏中黑水照见你自己——敢看多久（智力/气运判定，败则神魂受寒）。",
      successText:"你在黑水里看见了自己所有的来处，包括那一段不属于此界的。你没有移开眼。盏，认了。",
      failText:"黑水里那个「你」先移开了眼——你如坠冰窟，神魂像被洗去了一层，钝痛三日。" },
  ...
  { id:"zhanjieDao", name:"斩界刀", region:null, realm:17, flag:"pioneer_kezi", flagText:"见过牢城里那行刻字：「别信它的恭喜」",
    ...
    trial:{ check:"str*6+agi*6+luck*3+d30>75", hint:"器灵之试：刀意自发，接得住崩刃三百年积的杀气才算持刀人（力量/敏捷判定，败则重创）。",
      successText:"第一缕刀气贯体时你没有退——第二步，刀已在你手里轻得像一段月光。刀，认了。",
      failText:"杀气入体，你横飞出去撞碎半面牢墙——刃还在石中，你连刀柄都没能握紧。" },
  ...
  { id:"zhenshiDing", name:"镇世鼎", region:"zhongzhou", realm:15, flag:"l2Tianji", flagText:"买过天机楼那条「不存在的人」的消息",
    ...
    trial:{ check:"con*8+luck*3+d30>75", hint:"器灵之试：鼎负一朝气运，须以脊背承接龙脉一压（体质/气运判定，败则内伤）。",
      successText:"龙脉压下来的那一刻你没有跪——鼎身龙纹游上你的手臂，又温顺地伏了回去。鼎，认了。",
      failText:"万钧气运压塌了你的护体灵光，你单膝砸进地宫的青砖里，肋骨呻吟着归了位。" },
  ...
  { id:"qingmingDeng", name:"青冥灯", region:"yunzhou", realm:15, flag:"l2Duobao", flagText:"查过多宝阁灭门当夜的销赃旧档",
    ...
    trial:{ check:"int*8+luck*3+d30>70", hint:"器灵之试：灯火专烧传承——在它的焰里站住一瞬，烧不垮的才是传人（智力/气运判定，败则灼伤）。",
      successText:"青焰舔上你的识海，你的功法谱系在火里过了一遍——烧掉的只有杂芜。灯，认了。",
      failText:"青焰一沾即燃，你抱着头滚出井台半丈——发梢烧焦了，识海里一片空白地疼。" },
  ...
  { id:"tingchaoLuo", name:"听潮螺", region:"sihai", realm:15, flag:"seaGuixuHeard", flagText:"听闻北海归墟的禁忌（老船主的禁语）",
    ...
    trial:{ check:"agi*8+luck*3+d30>70", hint:"器灵之试：万里潮声入耳，须在一息之间辨出归墟那一缕（敏捷/气运判定，败则五感受创）。",
      successText:"万籁入耳你只取一瓢——那缕往北的、被吸走的声音。螺，认了。",
      failText:"潮声灌耳如万鼓齐擂，你眼前发黑栽进浪里，被人捞上来时耳朵里还在响。" },
  ...
  { id:"zhaoguJing", name:"照骨镜", region:null, realm:15, flag:"pioneer_xinwu", flagText:"见过旧货摊上那半张「邪性」的上古信物",
    ...
    trial:{ check:"int*9+luck*2+d30>75", hint:"器灵之试：镜照因果——看清自己线上缠着的所有结，不疯者为持镜人（智力/气运判定，败则心魔大涨）。",
      successText:"你看见了自己线上密密麻麻的结：灭门、信物、灰鹭、还有一根一直连到天外。你看完了，手还稳。镜，认了。",
      failText:"因果线绞成一锅沸水灌进眼里——你惨叫着摔了镜子（它没碎），心魔趁虚而入。" },
  ...
  { id:"wanguLing", name:"万蛊铃", region:"nanling", realm:15, flag:"l2Resolve", flagText:"了断过「夺信」那桩因果（战/交易/嫁祸/放手皆算）",
    ...
    trial:{ check:"con*8+int*4+d30>75", hint:"器灵之试：铃响则万蛊俯首——先让铃音过你的经脉，熬得住万蛊啃噬之痛（体质/智力判定，败则中毒重创）。",
      successText:"铃音过体，万蛊虚影顺经脉走了一圈，你哼都没哼——蛊林深处响起一片臣服的振翅声。铃，认了。",
      failText:"铃音入体如万蚁啃心，你蜷缩在蛊林里抽搐到半夜——铃没响，你先哑了。" },
  ...
  { id:"kurouBeye", name:"枯荣贝叶", region:"ximo", realm:15, flag:"shengYaoDone", flagText:"取到过那滴万年地心乳（重塑道基）",
    ...
    trial:{ check:"con*6+int*6+luck*2+d30>70", hint:"器灵之试：叶脉与心脉同频——在它枯荣一变的刹那守住自己的心律（体质/智力判定，败则心脉受创）。",
      successText:"叶枯的一瞬你的心也跟着停了半拍，随即稳稳接上——泉眼里枯了三千年的水，涨了。叶，认了。",
      failText:"枯荣之变乱了你的心律，你按住心口跪倒在泉边——半晌才找回自己的心跳。" },
...
/* ============ 可驯养妖灵兽（设定集第八章 · 灵宠缔结三法：幼兽豢养／武力收服／平等契约） ============
   四阶八只，由引擎调度遭遇；驯服即认魂（fx.pet，跨世可候）+ 属性成长 + 特性词条入命格——三者皆实得。
   method.ranch：豢养判定（属性 check）；method.force：武力收服（fx.boss 复用，战力随境界）。
   region 为 null 者随处可遇；cond 附加门槛（realm/luck）在 gm.js 场景内判。 */
const PETS = [
  { id:"xuediao", name:"雪貂·雪团", tier:1, region:null, realm:2,
    pct:{ agiP:15 }, card:"踏雪无痕|2|雪貂之灵附体：身法如雪上无痕|agiP:5,escapeP:5",
    scene:"雪堆里有东西在动。你扒开雪，一只通体雪白的貂崽蜷在里边，后腿被捕兽夹咬穿了，眼睛湿漉漉地瞪着你——不怕人，也不求人，就那么瞪着。",
    ranch:{ check:"int*6+con*4+luck*3+d30>55", hint:"豢养：替它开夹、包扎、喂它半个冬天（智力/体质判定，败则受创）。",
      ok:"夹子撬开，它疼得直哆嗦，却没咬你。一个月后，它开始睡在你的柴堆上——你唤它「雪团」。",
      ng:"开夹时它疼极反扑，在你手背上撕开一道血口，叼着断夹跑了——雪地上只留下一串小梅花印。" } },
  { id:"huiyi", name:"荒狼·灰耳", tier:1, region:"beiyuan", realm:3,
    pct:{ strP:15, dmgP:5 }, card:"狼顾|2|荒狼之魂：出手有狼性，孤注一掷|dmgP:5,strP:2",
    scene:"北原的暴风雪里，一头狼崽趴在母狼冻僵的尸身旁，一声一声地嚎。它右耳是灰的——北原人说，灰耳的狼崽，是狼群里最倔的那个。",
    ranch:{ check:"con*6+int*4+luck*3+d30>55", hint:"豢养：分它肉食、陪它熬过这场冻风（体质/智力判定，败则受伤）。",
      ok:"它先是不肯吃你递的肉，第三天，它把啃剩的半只雪兔放在你脚边——狼把口粮给你，就是认了你。你唤它「灰耳」。",
      ng:"它饿极了，抢肉时在你小臂上留下两排牙印，随后叼着肉消失在白毛风里。" } },
  { id:"chiling", name:"赤翎雀·小火", tier:2, region:null, realm:7,
    pct:{ intP:18 }, card:"雀鸣示警|2|赤翎雀之灵：六识先觉，险至先知|escapeP:8,intP:2",
    scene:"集市上有人兜售一只雀——通体火红，尾羽三根金翎，笼子里的它不叫，只拿眼睛打量你。摊主说它邪性：每逢灾祸前十日，必彻夜哀鸣。",
    ranch:{ check:"int*7+luck*3+d30>60", hint:"豢养：买笼（500 文）+ 以灵气温养（智力/气运判定，败则破财）。",
      ok:"你放它出笼，它绕梁三圈，落在你肩上——从此你的灾祸，它都先叫给你听。你唤它「小火」。",
      ng:"摊主收了钱，雀却在你开箱时惊飞而去，只剩一根金翎落在你掌心。" } },
  { id:"yanbei", name:"岩背龟·稳稳", tier:2, region:"nanling", realm:7,
    pct:{ conP:18, defP:5 }, card:"龟息|2|岩背龟之灵：气血绵长，不动如山|conP:3,defP:5",
    scene:"瘴林边的溪潭里趴着一头磨盘大的老龟，背甲上长着青苔与小树，不知活了几百年。它不怕人——南岭人说，它的甲上驮过一整个寨子的童年。",
    ranch:{ check:"con*6+luck*4+d30>60", hint:"契约：以灵契相邀，不驯不擒，它愿意才跟你走（体质/气运判定，败则拒契）。",
      ok:"你滴了一滴血在它的甲上。老龟缓缓抬起头，看了你很久，慢吞吞地爬上了岸——跟你走，是它的选择。你唤它「稳稳」。",
      ng:"老龟把头和四肢缩进甲里，再不出来。潭水恢复了平静——它拒绝了你。" } },
  { id:"yingbao", name:"影豹·逐影", tier:3, region:"nanling", realm:13,
    pct:{ agiP:25, escapeP:8 }, card:"影随形|3|影豹之灵：动如鬼魅，来去无形|agiP:10,escapeP:8",
    scene:"十万大山的夜色里，一双金瞳在你十丈外亮起——影豹。它不扑你，只是远远地跟着，像一团会呼吸的黑暗。三阶大妖灵智不逊于人：它在评估你。",
    ranch:{ check:"agi*8+int*4+luck*2+d30>80", hint:"契约：追上它、与它并肩跑完这座山——追不上，它一辈子看不起你（敏捷/智力判定，败则重创）。",
      ok:"你跑了整整一夜，天亮时与它同时跃上那道山梁。它回头看了你一眼，喉咙里滚出一声低鸣——平等契约，成立。你唤它「逐影」。",
      ng:"它在山梁上等你跑到脱力，然后优雅地跃走了——只留下一串轻蔑的梅花爪印。" },
    force:{ base:16, per:3, hint:"武力收服：把它打到服气（战力随境界而涨，九死一生）。" } },
  { id:"bitong", name:"碧瞳狐·阿碧", tier:3, region:"zhongzhou", realm:13,
    pct:{ intP:20, socialP:10 }, card:"狐鉴|3|碧瞳狐之灵：慧眼识人，人缘自来|intP:6,socialP:10",
    scene:"帝畿的鬼市深处，一只碧眼狐狸蹲在算命摊后，爪边摆着三枚铜钱——它自己就是摊主。它开口，是人言：「客官，测一个字？测准了，我跟你走。」",
    ranch:{ check:"int*9+luck*2+d30>80", hint:"契约：与它斗智——它出三问，答出两问，它认你为主（智力判定，败则心魔微涨）。",
      ok:"第三问你故意答错，它愣了愣，随即笑了——「肯在狐狸面前藏拙的，是聪明人。」它跳下摊位，碧瞳里映出你的影子。你唤它「阿碧」。",
      ng:"三问全对。它眯起眼：「无趣的聪明人，狐狸不要。」然后连摊带狐消失在夜色里。" },
    force:{ base:16, per:3, hint:"武力收服：动手抢狐（它会让你知道什么叫鬼市）。" } },
  { id:"qingjiao", name:"青蛟·小青", tier:3, region:"sihai", realm:13,
    pct:{ conP:20, strP:12, hpRegenP:8 }, card:"蛟息|3|青蛟之灵：气血如潮，生生不息|allP:5,hpRegenP:10",
    scene:"四海的渔民说，珠蚌埠外有个「守潮的」。你在风暴夜亲眼见到了——一条丈余的青蛟盘在礁上，替渔船挡着浪。它不是妖兽，它是这一带渔民供了三百年的「潮守」。",
    ranch:{ check:"con*8+int*5+luck*2+d30>80", hint:"契约：替它守一夜潮，让它歇一夜（体质/智力判定，败则被浪重创）。",
      ok:"天亮时风暴过去，青蛟睁开眼，把一枚鳞片留在你掌心——鳞片入水不沉。渔民说：潮守认了你，从此四海的风暴，都给你留一条道。你唤它「小青」。",
      ng:"一个浪头把你拍在礁上，青蛟替你挡了第二浪，把你推回岸边——然后不再看你。" },
    force:{ base:18, per:3, hint:"武力收服：对潮守亮刀，渔民第一个不答应（战力随境界而涨）。" } },
  { id:"baize", name:"白泽残裔·小泽", tier:4, region:null, realm:17, luck:6,
    pct:{ intP:30, allP:5 }, card:"白泽之瞳|4|白泽残裔之灵：通万物之情，晓鬼神之事——气运 +1|luckFlat:1,intP:5",
    scene:"你只是在荒野里迷了路。然后你看见了它——一头独角的小兽，雪一样的皮毛，正用一种「你怎么才走到这里」的眼神看着你。白泽。传说它知晓万物之名，只现于有德（或有大机缘）之人。",
    ranch:{ check:"int*8+luck*5+d30>85", hint:"契约：它问你三个问题——答的不是答案，是你这个人（智力/气运判定，败则缘尽此生不再现）。",
      ok:"第三个问题它没有评判，只是走过来，用独角轻轻碰了碰你的额头。无数名字涌入识海，又沉淀成一枚温润的印记。它说：「白泽认你。」",
      ng:"小兽听完你的回答，摇了摇头，踏云而去——你只看见它在天边回头望了一眼，像望一个擦肩而过的可能。" },
